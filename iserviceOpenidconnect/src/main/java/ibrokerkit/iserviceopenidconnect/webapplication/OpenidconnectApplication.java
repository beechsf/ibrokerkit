...
import ibrokerkit.iserviceopenidconnect.webpages.error.InternalError;
import ibrokerkit.iserviceopenidconnect.webpages.error.PageExpired;
import ibrokerkit.iserviceopenidconnect.webpages.index.Index;
import ibrokerkit.iserviceopenidconnect.webpages.iservice.CustomPage;
import ibrokerkit.iserviceopenidconnect.webpages.iservice.EndpointStrategy;
...
public class OpenidconnectApplication extends SpringWebApplication {
	...
	public void init() {
		...
		this.getApplicationSettings().setClassResolver(new OpenidconnectClassResolver());
	...
	protected IRequestCycleProcessor newRequestCycleProcessor() {
		...
		return(new OpenidconnectRequestCycleProcessor());
	}
	...
	public Session newSession(Request request, Response response) {
		...
		return(new OpenidconnectSession(request));
	}
