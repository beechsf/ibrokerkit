		...
		private class AuthenticateButton extends Button {
			...
			public void onSubmit() {
				...
				if (AuthenticationForm.this.staySignedIn.booleanValue()) {
					...
					((OpenidconnectSession) this.getSession()).loginUser(outIdentity);
				}

				// create OpenID response

				String endpointUrl = ((OpenidconnectApplication) this.getApplication()).getProperties().getProperty("endpoint-url");
