...
public class OpenIDJob extends Job {

	private String xri;
	
	public OpenIDJob(String xri) {
	...
	public void execute(Resolver resolver) throws PartialResolutionException, IllegalTrustTypeException {
		...
		this.result.append("OpenID endpoint(s) for " + this.xri + ":<br>");
		...
		this.oneLineResult.append("OpenID endpoint(s) for " + this.xri + ": ");
