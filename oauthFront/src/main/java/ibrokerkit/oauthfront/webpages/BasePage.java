package ibrokerkit.oauthfront.webpages;

import ibrokerkit.oauthfront.components.MyVelocityContributor;
import ibrokerkit.oauthfront.components.MyVelocityPanel;
import ibrokerkit.oauthfront.velocity.Encoder;
...
public abstract class BasePage extends WebPage {
	...
	public BasePage() {
		...
		Properties properties = ((OauthApplication) this.getApplication()).getProperties();
	...
	protected void addVelocity(final MyVelocityPanel subVelocityPanel) {
		...
		this.add(new MyVelocityContributor(Model.valueOf(this.velocityMap)) {
			...
			protected IStringResourceStream getTemplateResource() {
				...
				String file = "velocity/oauth-head.vm";
