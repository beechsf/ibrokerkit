...
import ibrokerkit.oauthfront.webpages.error.ExceptionPage;
...
public class OauthRequestCycleProcessor extends UrlCompressingWebRequestProcessor {

	private static Log log = LogFactory.getLog(OauthRequestCycleProcessor.class.getName());
