...
public class IndexPage extends ForwardingBasePage implements IHeaderContributor {

	private static final long serialVersionUID = 2608885789316101727L;

	private Forwarding forwarding;
	private XRI qxri;
	private XRD xrd;

	public IndexPage(Forwarding forwarding, XRI qxri, XRD xrd) {
		...
		this.addVelocity(new MyVelocityPanel("velocity", Model.of(this.velocityMap)) {
			...
			protected String getFilename() {
				...
				return("velocity/forwarding-forwardingindex.vm");
			}
		});
	}
