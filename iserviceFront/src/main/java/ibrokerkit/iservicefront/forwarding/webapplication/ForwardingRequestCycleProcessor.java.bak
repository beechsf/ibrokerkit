...
import ibrokerkit.iservicefront.forwarding.webpages.error.ExceptionPage;
...
public class ForwardingRequestCycleProcessor extends UrlCompressingWebRequestProcessor {

	private static Log log = LogFactory.getLog(ForwardingRequestCycleProcessor.class.getName());
