...
public class AuthenticationRequestCycleProcessor extends UrlCompressingWebRequestProcessor {

	private static Log log = LogFactory.getLog(AuthenticationRequestCycleProcessor.class.getName());
