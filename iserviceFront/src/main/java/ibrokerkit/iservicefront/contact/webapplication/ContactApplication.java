...
import ibrokerkit.iservicefront.contact.webpages.error.InternalError;
import ibrokerkit.iservicefront.contact.webpages.error.PageExpired;
import ibrokerkit.iservicefront.contact.webpages.index.Index;
import ibrokerkit.iservicefront.contact.webpages.iservice.CustomPage;
import ibrokerkit.iservicefront.contact.webpages.iservice.EndpointStrategy;
...
public class ContactApplication extends SpringWebApplication {
	...
	public void init() {
		...
		this.getApplicationSettings().setClassResolver(new ContactClassResolver());
	...
	protected IRequestCycleProcessor newRequestCycleProcessor() {
		...
		return(new ContactRequestCycleProcessor());
	}
	...
	public Session newSession(Request request, Response response) {
		...
		return(new ContactSession(request));
	}
