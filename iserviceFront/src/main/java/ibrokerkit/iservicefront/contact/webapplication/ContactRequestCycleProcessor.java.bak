...
import ibrokerkit.iservicefront.contact.webpages.error.ExceptionPage;
...
public class ContactRequestCycleProcessor extends UrlCompressingWebRequestProcessor {

	private static Log log = LogFactory.getLog(ContactRequestCycleProcessor.class.getName());
