...
import ibrokerkit.iservicefront.locator.webpages.error.ExceptionPage;
...
public class LocatorRequestCycleProcessor extends UrlCompressingWebRequestProcessor {

	private static Log log = LogFactory.getLog(LocatorRequestCycleProcessor.class.getName());
