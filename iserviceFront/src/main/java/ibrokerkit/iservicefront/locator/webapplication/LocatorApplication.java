...
import ibrokerkit.iservicefront.locator.webpages.error.InternalError;
import ibrokerkit.iservicefront.locator.webpages.error.PageExpired;
import ibrokerkit.iservicefront.locator.webpages.index.Index;
import ibrokerkit.iservicefront.locator.webpages.iservice.CustomPage;
import ibrokerkit.iservicefront.locator.webpages.iservice.EndpointStrategy;
...
public class LocatorApplication extends SpringWebApplication {
	...
	public void init() {
		...
		this.getApplicationSettings().setClassResolver(new LocatorClassResolver());
	...
	protected IRequestCycleProcessor newRequestCycleProcessor() {
		...
		return(new LocatorRequestCycleProcessor());
	}
	...
	public Session newSession(Request request, Response response) {
		...
		return(new LocatorSession(request));
	}
