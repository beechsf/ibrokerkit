package ibrokerkit.iservicefront.locator.webpages;
...
public abstract class BasePage extends WebPage {
	...
	public BasePage() {
		...
		Properties properties = ((LocatorApplication) this.getApplication()).getProperties();
	...
	protected void addVelocity(final MyVelocityPanel subVelocityPanel) {
		...
		this.add(new MyVelocityContributor(Model.valueOf(this.velocityMap)) {
			...
			protected IStringResourceStream getTemplateResource() {
				...
				String file = "velocity/locator-head.vm";
		...
		this.add(new MyVelocityPanel("velocity", Model.valueOf(this.velocityMap)) {
			...
			protected String getFilename() {
				...
				return("velocity/locator-base.vm");
			}
		});
	}
}
