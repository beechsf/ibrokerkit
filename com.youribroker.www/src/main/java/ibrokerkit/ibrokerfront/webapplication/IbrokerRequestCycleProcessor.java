...
import ibrokerkit.ibrokerfront.webpages.error.ExceptionPage;
...
public class IbrokerRequestCycleProcessor extends UrlCompressingWebRequestProcessor {

	private static Log log = LogFactory.getLog(IbrokerRequestCycleProcessor.class.getName());
