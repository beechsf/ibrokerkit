...
import ibrokerkit.iserviceadmin.webpages.error.ExceptionPage;
...
public class IServiceAdminRequestCycleProcessor extends UrlCompressingWebRequestProcessor {

	private static Log log = LogFactory.getLog(IServiceAdminRequestCycleProcessor.class.getName());
